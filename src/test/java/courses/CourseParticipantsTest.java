...
public class CourseParticipantsTest {
  // given
  private final CourseParticipants courseParticipatns = new CourseParticipants(10);
  ...
  public void testWaitingStudentsList() {
    // given
    final CourseParticipants testCourseWithTwoSeats = new CourseParticipants(2);
    ...
    assertEquals(2, testCourseWithTwoSeats.getRegisteredStudentsListList().size());
